...
step0_copy_code()
{
	...
	sed "s/\`echo \$LINUX_COMPILE_BY | \$UTS_TRUNCATE\`/Boeffla-Kernel-$BOEFFLA_VERSION-$BOEFFLA_DATE-[supported-by-www.android-hubo.de]/g" -i $BUILD_PATH/scripts/mkcompile_h
